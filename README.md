...
Ao terminar a instalação é só logar com os dados padrão, caso não saiba veja na página do projeto [whasapo](https://github.com/lolalos/crmwhsapo).
...
```
## Recursos 
- Multi instalador ilimitado [whasapo](https://github.com/lolalos/crmwhsapo)
...
## Versão Debian
- [instalador whasapo](https://github.com/lolalos/instalador-whasapo.git)

## Instalação manual
- [whasapo](https://github.com/lolalos/crmwhsapo)
