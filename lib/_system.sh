...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código whasapo...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  sudo su - deploy <<EOF
  git clone https://github.com/lolalos/crmwhsapo /home/deploy/${instancia_add}/
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema whasapo...${GRAY_LIGHT}"
  printf "\n\n"
